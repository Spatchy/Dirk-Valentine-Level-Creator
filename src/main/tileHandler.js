...
function getTileLibrary() {
  if(settingsManager.getSetting("flashpointPath") && settingsManager.getSetting("swftoolsPath")) {
    return [
      ...
      new Tile(261, "gas-pipe-intermittent-start-low-upwards", "832.png", [], 1, 1, 270),
      new Tile(262, "gas-pipe-intermittent-start-low-rightwards", "832.png"),
      new Tile(263, "gas-pipe-intermittent-start-low-downwards", "832.png", [], 1, 1, 90),
